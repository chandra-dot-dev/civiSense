    ...
    <div className="space-y-6 pb-12 mx-auto max-w-4xl">
      <div className="flex items-center space-x-4 mb-4">
        ...
        <div className="text-sm font-medium text-slate-500 flex items-center space-x-2">
          ...
          <span>/</span>
          <span className="text-xs font-mono font-bold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 px-2 py-1 rounded border border-slate-200 dark:border-slate-800 shadow-sm max-w-[120px] truncate">TKN-{complaint.id.split('-')[0].substring(0, 5).toUpperCase()}</span>
        </div>
      </div>
